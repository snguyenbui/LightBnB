...
VALUES (1, 'FC Mansion', 'description', 'https://someurl.com/img/hashtag', 'https://someurl.com/img/hashtag', 12432988, 250, 30, 512, 'Othard', '60 Plot Street', 'Shirogane', 'Hingashi', '6W4 R4D', TRUE),
(6, 'Cardboard Box', 'description', 'https://someurl.com/img/hashtag', 'https://someurl.com/img/hashtag', 0, 0, 0, 0, 'Canada', '123 Fake Street', 'Vancouver ', 'BC', '1A2 B3C', FALSE),
(7, 'Yeet Haw', 'description', 'https://someurl.com/img/hashtag', 'https://someurl.com/img/hashtag', 400, 1, 2, 2, 'USA', '6th Street', 'Austin', 'Texas', '68795', TRUE),
(4, 'Rogers Arena', 'description', 'https://someurl.com/img/hashtag', 'https://someurl.com/img/hashtag', 25000, 200, 20, 0, 'Canada', '800 Griffiths Way', 'Vancouver', 'BC', 'V6B6G1', TRUE),
(6, 'That House', 'description', 'https://someurl.com/img/hashtag', 'https://someurl.com/img/hashtag', 100, 3, 3, 4, 'Canada', '132 Street', 'Surrey', 'BC', 'V3T 3T8', TRUE);
